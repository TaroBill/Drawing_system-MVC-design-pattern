...
namespace Homework2DrawingSystem.Model.Shapes
{
    public class Ellipse : IShape
    {
        ...
        {
            graphics.DrawEllipse(_locationX1, _locationY1, _locationX2, _locationY2);
        }
        ...
        {
            graphics.DrawEllipseFrame(_locationX1, _locationY1, _locationX2, _locationY2);
        }
        ...
        public override string ToString()
        {
            ...
            const string COMMA = ",";
            return ELLIPSE + LEFT_QUOTE + _locationX1 + COMMA + _locationY1 + COMMA  +_locationX2 + COMMA + _locationY2 + RIGHT_QUOTE;
        }
        ...
        public void Deserialize(string inputString, Model model = null)//格式為(locationX1,locationY1,locationX2,locationY2)
        {
            ...
            _ = double.TryParse(locations[ZERO], out _locationX1);
            _ = double.TryParse(locations[ONE], out _locationY1);
            _ = double.TryParse(locations[TWO], out _locationX2);
            _ = double.TryParse(locations[THREE], out _locationY2);
        }
